...
//    }
    table->setHorizontalHeaderItem(0, new QTableWidgetItem(QString("食物种类")));
    table->setHorizontalHeaderItem(1, new QTableWidgetItem(QString("膳食量(kg)")));
    table->setHorizontalHeaderItem(2, new QTableWidgetItem(QString("参考限量(mg/kg)")));
    table->setHorizontalHeaderItem(3, new QTableWidgetItem(QString("限量来源")));
    table->setHorizontalHeaderItem(4, new QTableWidgetItem(QString("NEDI(mg)")));
    table->setHorizontalHeaderItem(5, new QTableWidgetItem(QString("日允许摄入量（mg）")));
//    table->setHorizontalHeaderItem(1, new QTableWidgetItem(QString("风险概率（%）")));
